...
* `Gerador_Indicadores.py`: Código-fonte principal com toda a lógica do sistema.
* `estudos/`: Pasta contendo scripts de apoio e laboratórios de testes realizados durante o desenvolvimento com Pandas.
* `aluguel.csv`: Base de dados de referência.
